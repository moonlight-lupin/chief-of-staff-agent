...
description: "Use when inspecting Gmail labels, proposing or saving a label policy, or when the operator addresses 'Chief of Staff' (the CoS assistant name) to check email (e.g. 'Ask Chief of Staff to check my email'). Route all Gmail operations through the company workspace account configured in company.yaml for your organization, NOT the agent's personal email."
version: 0.1.0
