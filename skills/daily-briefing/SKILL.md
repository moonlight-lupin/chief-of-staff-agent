---
name: daily-briefing
description: "Use when producing the Chief-of-Staff daily command-center briefing from Gmail, Calendar, deadlines, pipeline, to-dos, and bookkeeping sources. When the user addresses '{assistant_name}' (the CoS assistant name), route all mail/calendar/file operations through the company workspace account configured in company.yaml for {company_name}, NOT the agent's personal email."
version: 0.1.0
