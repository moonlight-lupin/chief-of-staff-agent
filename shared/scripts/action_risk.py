...
_ACTION_EXPLANATIONS: dict[str, str] = {
    ...
    "contacts.create": "Creating a contact adds an entry to the address book; delete it if made in error.",
    "contacts.update": "Updating a contact overwrites the supplied fields; prior values are not recorded.",
    "contacts.delete": "Deleting a contact is permanent — there is no trash step to restore from.",
