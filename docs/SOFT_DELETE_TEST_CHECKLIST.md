...
Provider: `google_api`, Composio Google, Composio Microsoft, or `m365`.

OneDrive **Business** restore needs the SharePoint recycle-bin path:
- `m365`: SharePoint app permission `Sites.ReadWrite.All`
